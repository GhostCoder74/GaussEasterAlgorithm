...
show:
	...
	@echo "│       ├── LICENSE"
	@echo "│       └── modules"
	@echo "│           ├── geaCal_calendar_data_mod.py"
	@echo "│           ├── geaCal_create_language_mod.py"
	@echo "│           ├── geaCal_easter_mod.py"
	@echo "│           ├── geaCal_holidays_mod.py"
	@echo "│           ├── geaCal_odbc_server_mod.py"
	@echo "│           ├── geaCal_utils_mod.py"
	@echo "│           ├── geaCal_translator_mod.py"
	@echo "│           ├── geaCal_web_provider_mod.py"
	@echo "│           └── geaCal_lang/*.json"
	@echo "├── usr"
	@echo "│   └── local"
	@echo "│       └── bin"
	@echo "│           ├── geaCal"
	@echo "│           └── geaCal-sql2csv-cli"
	@echo "└── usr"
	@echo "    └── share"
	@echo "        └── geaCal"
...
tree:
	...
	@echo "│           ├── geaCal_translator_mod.py"
	@echo "│           ├── geaCal_web_provider_mod.py"
	@echo "│           ├── geaCal_xml_gen_mod.py"
	@echo "│           ├── geaCal_xml_proxy_mod.py"
	@echo "│           └── geaCal_lang"
	@echo "│               ├── en.json"
	@echo "│               └── de.json"
	@echo "├── usr"
